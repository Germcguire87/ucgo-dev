...
## Summary
Server response carrying appearance/looks-related data.
...
- Observed once as the likely response counterpart to client opcode 0x0000000A.
...
- Opcode: `0x0000800A`
- Tentative name: `RESPONSE_PLAYER_LOOKS_BUFF`
