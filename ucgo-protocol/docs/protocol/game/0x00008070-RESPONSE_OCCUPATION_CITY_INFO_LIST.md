...
## Summary
Server response carrying occupation/city/faction-style world-state data.
...
- Observed twice as the likely response counterpart to client opcode 0x00000070.
...
- Opcode: `0x00008070`
- Tentative name: `RESPONSE_OCCUPATION_CITY_INFO_LIST`
