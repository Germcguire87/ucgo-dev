...
## Summary
Server response carrying server time or time-sync data.
...
- Observed once as the likely response counterpart to client opcode 0x00000013.
...
- Opcode: `0x00008013`
- Tentative name: `RESPONSE_SERVER_TIME`
