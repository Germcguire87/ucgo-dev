# 0x00008041 — RESPONSE_LOGIN_GAME
...
## Summary
Server response paired with the initial game-login request.
...
- Observed once as an early server bootstrap response after the client opened the 24010 session.
...
- Opcode: `0x00008041`
- Tentative name: `RESPONSE_LOGIN_GAME`
