...
## Summary
Server response carrying compact/basic player info.
...
- Observed once as the likely response counterpart to client opcode 0x00000006.
...
- Opcode: `0x00008006`
- Tentative name: `RESPONSE_SIMPLE_PLAYER_INFO`
