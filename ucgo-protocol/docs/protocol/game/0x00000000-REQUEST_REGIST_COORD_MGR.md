...
## Summary
Registers the client with the coordinate manager or world-position subsystem.
...
- Observed once during early bootstrap; larger structured payload than the tiny setup packets.
...
- Opcode: `0x00000000`
- Tentative name: `REQUEST_REGIST_COORD_MGR`
